  ...
  <Teleport to="body">
    <Transition name="toast">
      ...
      >
        ...
        >
          <IconSprite v-if="isError" name="alert-circle" size="18" class="text-rose-500 dark:text-rose-400 shrink-0" />
          <IconSprite v-else name="check" size="18" :stroke-width="2.5" class="text-emerald-600 dark:text-emerald-400 shrink-0" />
          <span
